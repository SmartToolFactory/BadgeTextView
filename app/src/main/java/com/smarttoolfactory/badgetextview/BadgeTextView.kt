...
//        val textWidth = rect.width()
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        badgeShadowRadius = typedArray.getDimensionPixelOffset(
            R.styleable.BadgeTextView_badge_shadow_radius, dp2px(badgeShadowRadius)
        ).toFloat()
        badgeShadowXOffset =
            typedArray.getDimensionPixelOffset(
                R.styleable.BadgeTextView_badge_shadow_offset_x, dp2px(badgeShadowXOffset)
            ).toFloat()
        badgeShadowYOffset =
            typedArray.getDimensionPixelOffset(
                R.styleable.BadgeTextView_badge_shadow_offset_y, dp2px(badgeShadowYOffset)
            ).toFloat()
        badgeShadowColor =
        ...
        // Debug
        isDebug = typedArray.getBoolean(R.styleable.BadgeTextView_debug, false)
    ...
    // TODO Add Compose style Modifier and Scope to set attributes and chain them
    interface Modifier {
